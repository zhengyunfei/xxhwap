(function(b) {
    b.fn.fakeLoader = function(m) {
        ...
        m);
        var l='<div class="htmleaf-container"><main class="loaded"><div class="loaders"><div class="loader"><div class="loader-inner pacman"><div style=""></div><div></div><div></div><div></div><div></div></div></div></div></main></div>';
        var ll = '<div class="fl spinner1"><div class="double-bounce1"></div><div class="double-bounce2"></div></div>';
