 ...
 *
 */
public class FindUserInfoByOpenIdDirective implements TemplateDirectiveModel {
	...
	public void execute(Environment env, Map params, TemplateModel[] model,
		...
		try {
			...
			TudouBookInfo book=bookService.findLastSendBook(queryMap);
			if(!StringUtils.isEmpty(book)){
				env.setVariable("codeValue", ObjectWrapper.DEFAULT_WRAPPER.wrap(book.getMobile()));
			}
		}catch (Exception e){
			e.printStackTrace();
		}
